...
val tekken8CharacterMoves = ImmutableList(
    listOf(
        ...
        // Common Stances
        MoveEntry(moveName = "Side Switch", notation = "s/s", moveType = "Common", character = "Generic", game = "Tekken 8"),
        ...
        MoveEntry(moveName = "Crouch", notation = "crouch", moveType = "Common", character = "Generic", game = "Tekken 8"),
        MoveEntry(moveName = "Dash", notation = "dash", moveType = "Common", character = "Generic", game = "Tekken 8"),
        MoveEntry(moveName = "Sidestep Left", notation = "s/l", moveType = "Common", character = "Generic", game = "Tekken 8"),
        MoveEntry(moveName = "Sidestep Right", notation = "s/r", moveType = "Common", character = "Generic", game = "Tekken 8"),
